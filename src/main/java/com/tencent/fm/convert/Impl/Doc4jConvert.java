...
//            fontMapper.put("等线", PhysicalFonts.get("Arial Unicode MS"));  字体别名的问题 找出原因来 或者找出解决方案来
             ...
             * 调试下需要
             */
            if (true) { foSettings.setFoDumpFile(new java.io.File( "test.fo")); }
